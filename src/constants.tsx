import { Bot, Brain, Cloud, Code, Database, Globe, Layers, Server, Terminal, Cpu, LineChart, Zap } from 'lucide-react';
...
export const PERSONAL_INFO = {
  ...
  tagline: "Translating complex data into actionable intelligence through scalable AI solutions.",
  email: "dev.mike.llc@gmail.com",
  location: "United States (Remote)",
  socials: {
    github: "github.com/r33ldev",
...
export const EXPERIENCE_DATA: ExperienceItem[] = [
  {
    ...
    description: "Spearheaded the integration of predictive modeling for pricing algorithms. Orchestrated ML ops pipelines on AWS SageMaker, automating model retraining and deployment. Managed a data-centric architecture handling over 10,000 users and 500M NGN revenue.",
  ...
  },
  {
    ...
    description: "Led the development of recommendation engines using collaborative filtering. Analyzed vast application usage datasets to identify behavioral patterns, directly influencing product roadmap via data-driven insights. Optimized Python-based data processing pipelines.",
    tags: ["Recommendation Systems", "Data Analytics", "Pandas", "Scikit-Learn"]
  },
  {
    id: 3,
    ...
    description: "Developed 'Zwilt Tracker', utilizing Computer Vision to analyze user activity via screenshot processing. Incorporated NLP algorithms into recruitment processes for automated candidate screening, improving hiring efficiency by 40%.",
  ...
  },
  {
    ...
    description: "Designed scalable RESTful APIs serving machine learning model inference. Built internal dashboards for visualizing model performance metrics using Python Django and React.",
...
export const SKILLS_DATA = [
  {
    ...
    tools: ["TensorFlow", "PyTorch", "Scikit-learn", "OpenCV", "HuggingFace", "Pandas", "NumPy", "LLMs (GPT/Llama)"]
  },
  {
    id: 'backend',
    ...
    tools: ["Python", "Django", "FastAPI", "Node.js", "GoLang", "PostgreSQL", "GraphQL", "Redis"]
  },
  {
    id: 'cloud',
    name: "MLOps & Cloud",
    ...
    tools: ["AWS SageMaker", "Docker", "Kubernetes", "GitHub Actions", "Terraform", "MLflow", "Prometheus"]
  }
];
...
export const SERVICES_DATA = [
  {
    ...
    description: "Defining the roadmap for integrating AI into your existing business processes to drive efficiency.",
    icon: <LineChart className="h-6 w-6" />
  },
  {
    title: "Custom ML Model Development",
    description: "Building bespoke predictive models, recommendation engines, and NLP solutions tailored to your data.",
    icon: <Cpu className="h-6 w-6" />
  },
  {
    title: "MVP to Scale",
    description: "Rapidly prototyping AI concepts and architecting the infrastructure to scale them to millions of users.",
    icon: <Zap className="h-6 w-6" />
  },
  {
    title: "MLOps Pipeline Automation",
    description: "Setting up robust CI/CD pipelines for machine learning, ensuring reliable training and deployment cycles.",
...
export const TESTIMONIALS_DATA = [
  {
    id: 1,
    name: "Sarah Jenkins",
    role: "Product Manager at Checkin Inc",
    content: "Michael's ability to translate complex data requirements into a seamless recommendation engine was impressive. He doesn't just write code; he understands the business value of AI.",
    avatar: "https://randomuser.me/api/portraits/women/44.jpg"
  },
  {
    id: 2,
    name: "David Okon",
    role: "CEO at Thrillers Group",
    content: "As our CTO, Mike transformed our entire infrastructure. His work on the pricing prediction algorithm directly increased our revenue by 15% in the first quarter.",
