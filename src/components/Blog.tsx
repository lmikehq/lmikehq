    ...
    <section className={`bg-slate-50 ${isPreview ? 'py-20' : 'pt-32 pb-20'}`}>
      <div className="container mx-auto max-w-6xl px-6">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold text-slate-900">{isPreview ? "Latest Articles" : "The MikeHQ Blog"}</h2>
            <p className="mt-4 text-slate-600">
              Thoughts on AI architecture, system design, and the future of tech.
            </p>
          </div>
          {isPreview && onViewAll && (
            <button 
          ...
          {displayPosts.map((post, idx) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <button className="flex items-center gap-2 text-sm font-semibold text-primary-600 transition-colors group-hover:text-primary-700">
                  Read Article
