      ...
      <div className="container mx-auto grid max-w-6xl grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
        ...
        >
          ...
          <h1 className="mb-6 text-5xl font-bold tracking-tight text-slate-900 sm:text-6xl lg:text-7xl">
            Hi, I'm <span className="text-primary-600">{PERSONAL_INFO.name.split(' ')[0]}</span>
          </h1>
          ...
          <div className="mt-10 flex gap-6 text-slate-400">
             <a href={`https://${PERSONAL_INFO.socials.github}`} target="_blank" rel="noreferrer" className="hover:text-primary-600 transition-colors">
               <Github className="h-6 w-6" />
             </a>
             <a href={`https://${PERSONAL_INFO.socials.linkedin}`} target="_blank" rel="noreferrer" className="hover:text-primary-600 transition-colors">
        ...
        >
          <div className="relative">
            ...
            >
              <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" className="h-8 w-8" alt="Python" />
            </motion.div>
            ...
            >
              <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tensorflow/tensorflow-original.svg" className="h-8 w-8" alt="TF" />
            </motion.div>
          </div>
        </motion.div>
      </div>
