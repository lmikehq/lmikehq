...
const ChatWidget: React.FC = () => {
  ...
  >([
    {
      role: "bot",
      text: "Hi! I'm MikeHQ's AI Assistant. Ask me anything about Mike's skills or availability!",
    },
  ]);
  ...
  const handleSend = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      let response =
        "That's a great question! Mike specializes in building scalable ML pipelines and AI architectures. You should definitely reach out to him directly via the contact form!";

      if (
        inputValue.toLowerCase().includes("python") ||
        inputValue.toLowerCase().includes("code")
      ) {
        response =
          "Mike is a Python expert! He's been using it for over 5 years for everything from backend APIs to complex Deep Learning models.";
      } else if (
        inputValue.toLowerCase().includes("hire") ||
        inputValue.toLowerCase().includes("job")
      ) {
        response =
          "Mike is currently open to new opportunities! He is looking for Machine Learning Engineer or AI Architect roles.";
      }
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <button
                    type="submit"
                    className="absolute right-2 top-1.5 rounded-full p-1 text-primary-600 hover:bg-primary-50"
                  >
